package com.juliogarcia.bookstoremanager.exception;
...
public class BookstoreExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handlerEntityNotFoundException(EntityNotFoundException exception){
		 return buildResposeEntity(HttpStatus.NOT_FOUND,
	...
	public ResponseEntity<Object> handlerEntityExistsException(EntityExistsException exception){
		return buildResposeEntity(HttpStatus.BAD_REQUEST,
				exception.getMessage(),
				Collections.singletonList(exception.getMessage()));
	}
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException exception, HttpHeaders headers, HttpStatus status, WebRequest request) {
		...
		return buildResposeEntity(HttpStatus.BAD_REQUEST, "Informed argument(s) validation Error", errors);
	}
	...
	private ResponseEntity<Object> buildResposeEntity(HttpStatus httpStatus, String message, List<String> errors) {
